...
export function EventSummaryPopover({ isOpen, onClose, event }: EventSummaryPopoverProps) {
  ...
  return (
    ...
    >
      <div
        ref={popoverRef}
        className="w-full max-w-md rounded-lg bg-white dark:bg-gray-900 p-6 shadow-lg animate-scale-in"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-xl font-semibold dark:text-white">Event Summary</h2>
          <Button 
            variant="ghost" 
            size="icon" 
            onClick={onClose}
        ...
        <div className="space-y-2 animate-fade-in-up dark:text-gray-300">
